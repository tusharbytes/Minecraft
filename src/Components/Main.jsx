            ...
            <Container>
                <div className='sm:flex   '>
                    <div className='   py-4 font-bold  '>
                        <h1 className='  text-white text-2xl  lg:text-4xl p-2 tracking-widest  font-serif'>MINECRAFT SERVER</h1>
                        <h2 className='text-white text-2xl    md:text-4xl p-2 tracking-widest font-serif'>HOSTING</h2>
                        <h3 className='text-white text-2xl  md:text-3xl p-2 font-serif '>AND 60+ TOP ONLINE GAMES</h3>
                        <ul className='text-[#A9ABC7]  ml-2  py-8 opacity-0.05 font-bold '>
